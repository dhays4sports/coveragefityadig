...
check('release version remains compatible after DOC-1.1', ['3.19.29','3.19.31','3.20.0','3.20.1','3.20.2','3.20.4','3.20.5','3.20.6','3.20.7','3.20.8','3.20.10','3.20.11','3.20.12'].includes(version));
...
check('consultation guide uses sequential call-ready topic structure', ['What we know','Ask','What to explore','Check','Notes'].every(label => guideSectionSource.includes(label)));
check('consultation guide includes decisions missing items and next action', guideSectionSource.includes('Decisions and proposal plan') && guideSectionSource.includes('Still needed') && guideSectionSource.includes('Next action'));
...
check('generated document includes decisions workspace and next action', html.includes('Decisions and proposal plan') && html.includes('prepare a home and auto bundle comparison'));
check('generated document uses call-ready consultation guide', html.includes('Home Coverage Consultation Guide'));
