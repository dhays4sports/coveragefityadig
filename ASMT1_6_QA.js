...
check('release version is ASMT-1.6', ['3.20.6','3.20.7','3.20.8','3.20.10','3.20.11','3.20.12'].includes(version));
check('package version is ASMT-1.6', ['3.20.6','3.20.7','3.20.8','3.20.10','3.20.11','3.20.12'].includes(JSON.parse(read('package.json')).version));
...
check('consultation document renders homeowner answers', renderedGuide.html.includes('What they told us'));
check('consultation document renders policy checks', renderedGuide.html.includes('Check the policy'));
check('consultation document renders homeowner questions', renderedGuide.html.includes('Ask the homeowner'));
