...
check('release version remains compatible after ASMT-1.8', ['3.20.10','3.20.11','3.20.12'].includes(version) && pkg.version === version);
...
check('Agent Workspace normalization is unchanged', hash('assets/js/workspace-data.js') === '985a14895e1382ea62b210448387f33939bbb43e52fc752722b40fd6de33ecc5');
check('consultation inbox and notification path are unchanged', hash('server/consultation-inbox-core.mjs') === 'a9d3d7c5dad61145810bfc5acf7ab642c5854280f7f1e632452b01a3c7c2601a');
